<template>
  <v-card :loading="isUpdating" dark flat tile :disabled="isUpdating">
    ...
    <v-form v-model="valid" ref="bilty_form">
      <v-container class="px-8 py-2">
        <v-row>
          ...
          <v-col cols="12" md="2">
            <v-btn :loading="isUpdating" color="warning" @click="isUpdating = 'load'">
        ...
        <v-row>
          <v-col cols="12" md="4">
            <v-text-field v-model="lc_bl_no" dense filled :rules="numberRule" label="L/C - B/L No"></v-text-field>
          </v-col>
          <v-col cols="12" md="4">
            <v-text-field
...
export default {
  ...
  methods: {
    ...
    save() {
      if (this.$refs.form.validate()) {
        if (this.editedIndex > -1) {
          this.editedItem.quantity = this.editedItem.quantity.trim();
          this.editedItem.total_weight = this.editedItem.total_weight.trim();
          this.editedItem.labour = this.editedItem.labour.trim();
          this.editedItem.rate = this.editedItem.rate.trim();
          this.editedItem.total_volume = this.editedItem.total_volume.trim();
    ...
    emptyFields() {
      ...
      this.name = "";
      this.packages = [];
      this.status_item_value = "";
      this.payment_status_item_value = "";
      this.valid = true;
